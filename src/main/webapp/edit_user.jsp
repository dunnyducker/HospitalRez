...
<div class="bg-light" style="min-height:100%">
    ...
    <h1 class="text-center pt-3"><fmt:message key="title.edit_user" bundle="${general}"/></h1>
    <div class="row m-0">
        <div class="col-1"></div>
        <div class="col-10">
            ...
            <form class="form-group tab-content mr-5 ml-5" id="myTabContent" method="POST" action="/serv" enctype="multipart/form-data">
                        ...
                        <div class="col-8">
                                ...
                                <div class="col-6 pl-0">
                                    ...
                                    <div class="row input-group-text bg-light border-0 pt-0 pb-0">
                                        ...
                                        <input type="password" class="form-control form-control-sm ${status}" name="password"
                                               ...
                                               data-toggle="tooltip" data-placement="bottom"
                                               title="<fmt:message key = 'validation.user.password' bundle='${validation}'/> <fmt:message key = 'validation.user.password_change' bundle='${validation}'/>"/>
                                    </div>
                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-6 pr-0">
                                    ...
                                    <input type="hidden" name="photo_id" value="${user.photo.id}"/>
                                    <div class="row input-group-text bg-light border-0 pt-0 pb-0">
                ...
                <div class="d-flex pt-5 p-2 justify-content-center">
                    ...
                    <a href="/serv?action=view_user&id=${user.id}" class="btn btn-danger col-3 ml-5">
                        <fmt:message key="button.back" bundle="${general}"/>
                    </a>
                </div>
            </form>
        </div>
