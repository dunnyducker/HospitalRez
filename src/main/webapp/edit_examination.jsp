    ...
    <div class="row m-0">
        ...
        <div class="col-10">
            ...
            <div class="row d-flex justify-content-end pr-3 pl-3">
                <a data-toggle="modal" href="#assignmentModal" class="btn btn-sm col-1 btn-primary" data-mode="add"
                   data-examination-id="${examination.id}" data-doctor-id="${doctor.id}" data-patient-id="${patient.id}">
